...
<div id="page-nav" class="page-nav smoothscroll">
  <a id="previous" class="previous" href="#branding"><span class="previous glyphicon glyphicon-chevron-up"></span></a>
  <a id="next" class="next" href="#0" onclick="$(this).parent().hide();" ><span class="next glyphicon glyphicon-chevron-down"></span></a>
</div>